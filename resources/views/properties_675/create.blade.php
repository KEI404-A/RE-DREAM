    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4>Add New Property 675</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('properties_675.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="mb-3">
                        <label for="title_675" class="form-label">Title</label>
                        <input type="text" class="form-control @error('title_675') is-invalid @enderror" 
                               id="title_675" name="title_675" value="{{ old('title_675') }}">
                        @error('title_675')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description_675') is-invalid @enderror" 
                                  id="description_675" name="description_675" rows="4">{{ old('description_675') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('price_675') is-invalid @enderror" 
                                       id="price_675" name="price_675" value="{{ old('price_675') }}">
                                @error('price_675')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('location_675') is-invalid @enderror" 
                                       id="location_675" name="location_675" value="{{ old('location_675') }}">
                                @error('location_675')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('type_675') is-invalid @enderror" 
                                    ...
                                    <option value="house" {{ old('type_675') == 'house' ? 'selected' : '' }}>House</option>
                                    <option value="apartment" {{ old('type_675') == 'apartment' ? 'selected' : '' }}>Apartment</option>
                                    <option value="villa" {{ old('type_675') == 'villa' ? 'selected' : '' }}>Villa</option>
                                    <option value="office" {{ old('type_675') == 'office' ? 'selected' : '' }}>Office</option>
                                </select>
                                @error('type_675')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status_675') is-invalid @enderror" 
                                    ...
                                    <option value="available" {{ old('status_675') == 'available' ? 'selected' : '' }}>Available</option>
                                    <option value="sold" {{ old('status_675') == 'sold' ? 'selected' : '' }}>Sold</option>
                                    <option value="rented" {{ old('status_675') == 'rented' ? 'selected' : '' }}>Rented</option>
                                </select>
                                @error('status_675')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('bedrooms_675') is-invalid @enderror" 
                                       id="bedrooms_675" name="bedrooms_675" value="{{ old('bedrooms_675') }}">
                                @error('bedrooms_675')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('bathrooms_675') is-invalid @enderror" 
                                       id="bathrooms_675" name="bathrooms_675" value="{{ old('bathrooms_675') }}">
                                @error('bathrooms_675')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('area_675') is-invalid @enderror" 
                                       id="area_675" name="area_675" value="{{ old('area_675') }}">
                                @error('area_675')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('properties_675.index') }}" class="btn btn-secondary">
